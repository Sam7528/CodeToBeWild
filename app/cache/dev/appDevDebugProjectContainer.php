...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/CodeToBeWild/MapBundle/Resources/config/doctrine') => 'CodeToBeWild\\MapBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'CodeToBeWild\\MapBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CodeToBeWildMapBundle' => 'CodeToBeWild\\MapBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f4da11c5176bf89a3c215d3eb812a90946a58720372688c5a48b24a24f53b705');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CodeToBeWild/MapBundle/Resources/views'), 'CodeToBeWildMap');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b57ca3ed1643fa29aa340d6e88f747ffa04f23c7');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CodeToBeWildMapBundle' => 'CodeToBeWild\\MapBundle\\CodeToBeWildMapBundle',
            ...
            'locale' => 'fr',
            'secret' => 'b57ca3ed1643fa29aa340d6e88f747ffa04f23c7',
            ...
            'kernel.secret' => 'b57ca3ed1643fa29aa340d6e88f747ffa04f23c7',
